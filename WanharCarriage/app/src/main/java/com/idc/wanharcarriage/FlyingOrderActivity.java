...
public class FlyingOrderActivity extends AppCompatActivity implements NewDealerDialog.MyDialogListener,
    ...
    EditText edtOrderDate, edtweightTons, edtWeightBags, edtTotalCommission,
             edtBuiltyNumber, edtFinalDestination;
    ...
    public void readViews() {
        ...
        flyingDB = FirebaseDatabase.getInstance().getReference("FlyingOrder");
    ...
    public void addActions() {
        ...
        MyDatePicker mydatepicker = new MyDatePicker(FlyingOrderActivity.this,edtOrderDate);
    ...
    ValueEventListener getVehicleData = new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            ArrayAdapter myAdapter = new ArrayAdapter(FlyingOrderActivity.this,android.R.layout.simple_list_item_1,vehicles);
    ...
    ValueEventListener getDriverData = new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            ArrayAdapter myAdapter = new ArrayAdapter(FlyingOrderActivity.this,android.R.layout.simple_list_item_1,drivers);
    ...
    public void saveDelaer(String delaerid, String weight, String freight, String destination) {
        ...
        DealerOrder neworder = new DealerOrder(delaerid,weight,destination,freight,"F");
    ...
    void uploadFile(final String orderid) {
        ...
        try {
            ...
            Intent i ;
            i = new Intent(FlyingOrderActivity.this, FlyingActivity.class);
            if(caller.equals("Employee"))
                i = new Intent(FlyingOrderActivity.this, FlyingEmployeeDashboard.class);
    ...
    public void savePioneerOrder(View view) {
        ...
        final String newFlying = flyingDB.push().getKey();

        Functions.MyFunctions.displayDialog(getSupportFragmentManager());

        final String orderDate = edtOrderDate.getText().toString();
        ...
        FlyingOrder newOrder = new FlyingOrder(orderDate,builtynumber,vehicleselected,
                driver,weight,finaldestination,commission);

        flyingDB.child(newFlying).setValue(newOrder, new DatabaseReference.CompletionListener() {
            @Override
            public void onComplete(@Nullable DatabaseError databaseError, @NonNull DatabaseReference databaseReference) {
                if(databaseError == null){
                    //Functions.MyFunctions.displayMessage(getApplicationContext(),"Order Created");
                    saveIncome(newFlying);
                }else {
    ...
    public void saveIncome(final String orderid){
        ...
        incomeDB.child(incomeid).setValue(newincome, new DatabaseReference.CompletionListener() {
            ...
            public void onComplete(@Nullable DatabaseError databaseError, @NonNull DatabaseReference databaseReference) {
                if(databaseError == null){
                   // Functions.MyFunctions.displayMessage(getApplicationContext(),"Income saved Successfully");
                }else {
                    Functions.MyFunctions.displayMessage(getApplicationContext(),"There was a problem saving income");
                }
                Functions.MyFunctions.dismissDialog();
